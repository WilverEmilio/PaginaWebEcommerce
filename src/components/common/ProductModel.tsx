...
const ProductModal: React.FC<ProductModalProps> = ({
  ...
  // ✅ No renderizar si no hay datos o no está abierto
  if (!modaldata || !isOpen) {
    return null;
  }
  ...
  return (
    <>
      ...
      {/* ✅ Modal sin Bootstrap JS, solo CSS */}
      <div
                ...
                <div className="row">
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div className="product__modal-content">
                      {/* ✅ onClick para cerrar al ir a detalles */}
                      <h4>
                        <Link href={`/shop-details/${modaldata.id}`} onClick={onClose}>
                      ...
                      <div className="product__modal-form">
                        <div className="product-quantity-cart mb-30">
                          ...
                          {/* ✅ onClick para cerrar */}
                          <div>
                            <Link href="/cart" className="zoma-btn" onClick={onClose}>
                              Ver Carrito
                            </Link>
                          </div>
                        </div>
