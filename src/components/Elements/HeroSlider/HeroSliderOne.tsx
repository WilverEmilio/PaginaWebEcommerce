    ...
    if (loading) {
        return (
            <div className="slider-area">
                <div className="slider-height d-flex align-items-center justify-content-center">
                    <p>Cargando...</p>
                </div>
            </div>
        );
    ...
    return (
        <div className="slider-area">
            ...
            >
                ...
                {slides.map((item: Home) => (
                    <SwiperSlide key={item.id}>
                        <div className="single-slider">
                            <div 
                                className="slider-height d-flex align-items-center p-relative" 
                                style={{ 
                            ...
                            >
                                ...
                                <div className="slick-slider slider-navigation slider-active slick-initialized">
                                    <button type='button' className='slick-arrows slick-prev-1'>
                                        <i className='fas fa-chevron-left'></i>
                                    </button>
                                    <div className="slick-list"> </div>
                                    <button type='button' className='slick-arrows slick-next-1'>
